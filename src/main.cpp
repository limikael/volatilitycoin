...
unsigned int nStakeMinAge = 60 * 60 * 9 * 1; // 9 hours
...
const string strMessageMagic = "volatilitycoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if(pindexBest->nHeight < 1200001 )
    {
        nSubsidy = 5 * COIN;
    }
    else if(pindexBest->nHeight < 2000001 )
    {
        nSubsidy = 2.5 * COIN;
    }
    else if(pindexBest->nHeight < 10000001 )
    {
        nSubsidy = 1 * COIN;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "volatilitycoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Volatility Coin September Benjig";
        CTransaction txNew;
        txNew.nTime = 1410646441;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
       ...
       //// debug print
        assert(block.hashMerkleRoot == uint256("0xcbdd9a85238fda21fd1739709e7e16b1ddd7005d2a5ae922ac97b1a36ea9130c"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x1b, 0x2a, 0x0c, 0x3a };
