...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("volatilitycoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("volatilitycoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("volatilitycoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "volatilitycoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"node1.vlt.ssdpool.com", "node1.vlt.ssdpool.com"},
    {"node2.vlt.ssdpool.com", "node2.vlt.ssdpool.com"},
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("volatilitycoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("volatilitycoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("volatilitycoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("volatilitycoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. volatilitycoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("volatilitycoin-start");
